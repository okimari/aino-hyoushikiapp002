...
class LoginForm extends Component {
    ...
    render() {
        return (
            <div>
                <GoogleLoginButton onClick={this.googleLogin} align="center" iconSize={'20'} size={'40'} style={{ padding: '10px 0 10px 10px' }}>
                    <span style={{ fontSize: 16 }}>Googleで{this.props.formText}</span>
                </GoogleLoginButton>
                <TwitterLoginButton onClick={this.twitterLogin} align="center" iconSize={'20'} size={'40'} style={{ padding: '10px 0 10px 10px' }}>
                    <span style={{ fontSize: 16 }}>Twitterで{this.props.formText}</span>
                </TwitterLoginButton>
                <FacebookLoginButton onClick={this.facebookLogin} align="center" iconSize={'20'} size={'40'} style={{ padding: '10px 0 10px 10px' }}>
